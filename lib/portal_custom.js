...
export default class Portal extends React.Component {
  ...
  handleKeydown(e) {
    if (e.keyCode === KEYCODES.ESCAPE && this.state.active) {
      ...
      e.keyCode === KEYCODES.defaultProps &&
      this.openOnClickElement &&
      this.openOnClickElement === document.activeElement) {
      this.openPortal();
    }
  }
      ...
      return React.cloneElement(this.props.openByClickOn,
        {
          ...
          ref: (x) => { this.openOnClickElement = x; },
        });
    }
    return null;
  }
...
Portal.propTypes = {
  ...
  openOnDownArrow: PropTypes.bool,
};
